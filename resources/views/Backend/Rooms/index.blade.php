...
@section("content")
    ...
    <div class="container w-full md:w-full xl:w-full  mx-auto px-2">
        ...
        <a href="{{route('dashboard.room.create')}}" class="text-right"><button class="button text-white bg-theme-1 shadow-md mr-2 text-right">Add New Room</button></a>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#example').DataTable({
                ...
                ajax: "{{ route('dashboard.room.index') }}",
                columns: [
        ...
        if (confirm('Delete this Room?')) {
            $.ajax({
                ...
                success: function(affectedRows) {
                    ...
                    if (affectedRows > 0) window.location = "{{route('dashboard.room.index')}}";
                }
            });
        }
    }
