        ...
        <div id='recipients' class="mt-12 lg:mt-0 rounded shadow bg-white">
            <table id="example">
                ...
                <tr>
                    ...
                    <th data-priority="6">next Recurring Date</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#example').DataTable({
                ...
                ajax: "{{ route('dashboard.advancedpayment.index') }}",
                columns: [
                   // {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    ...
                    {data: 'next_recurring', name: 'next_recurring'},
...
<script>
    function deleteUser(package) {
        ...
        if (confirm('Delete this Customer Information?')) {
            $.ajax({
                type: "DELETE",
                url: 'advancedpayment/' + id, //resource
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}'
                },
