...
@section("content")
    ...
    <div class="container w-full md:w-full xl:w-full  mx-auto px-2">
        ...
        <a href="{{route('dashboard.roles.create')}}" class="text-right"><button class="button text-white bg-theme-1 shadow-md mr-2 text-right">Add New Roles</button></a>
        ...
        <div id='recipients' class="mt-12 lg:mt-0 rounded shadow bg-white">
            <table id="example">
                ...
                <tr>
                    ...
                    <th data-priority="2">Roles Name</th>
        ...
        if (confirm('Delete this Role?')) {
            $.ajax({
                ...
                success: function(affectedRows) {
                    ...
                    if (affectedRows > 0) window.location = "{{route('dashboard.roles.index')}}";
                }
            });
        }
    }
