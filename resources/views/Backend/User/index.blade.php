...
@section("content")
    ...
    <div class="container w-full md:w-full xl:w-full  mx-auto px-2">
        ...
        <a href="{{route('dashboard.user.create')}}" class="text-right"><button class="button text-white bg-theme-1 shadow-md mr-2 text-right">Add New User</button></a>
        ...
        if (confirm('Delete this User?')) {
            $.ajax({
                ...
                success: function(affectedRows) {
                    ...
                    if (affectedRows > 0) window.location = "{{route('dashboard.user.index')}}";
                }
            });
        }
    }
