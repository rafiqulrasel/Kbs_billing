...
class DueCollection extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Customer::where('next_recurring','<=',Carbon::now())->where('active_status', '=', 1);
        ...
        return view("backend.DueCollection.index");
    }
    ...
    public function edit($id)
    {
        ...
        return view("backend.DueCollection.create",compact('client','building','floor','room','payable_balence','collect_amount','available_balance'));
    ...
    public function update(Request $request, $id)
    {
       ...
       // dd(count($collect_bills_last)==0);
        ...
        if(count($collect_bills_last)==0){
           ...
           return view("backend.DueCollection.edit",compact('client','building','floor','room','lastBillInfo','totalMonth','packagename'));
